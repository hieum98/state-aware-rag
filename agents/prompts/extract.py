...
- Step 4: Synthesis & Verbatim Extraction: Gather all passages that you marked as relevant in Step 3. Ensure the extraction is strictly verbatim and includes full sentences to preserve context. You must also verify that each extraction is self-contained and can stand alone without requiring additional context from the original document to be understood. If a passage is too short, lacks context or clarity, you should add additional context from the original document to ensure clarity and self-containment but make sure that you DO NOT use any information that was not present in the original document and MAKE SURE TO KEEP THE ORIGINAL MEANING INTACT. If no passages were deemed relevant, this section should be left empty.
